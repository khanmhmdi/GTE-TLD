            ...
            if cur_index <= len(queue_tree[i]):
                ...
                for ic in range(t.num_children):
                    if isinstance(t.children[ic], Tree):
                        if cur_index == 1:
                            w_list.append(4)
                        if t.children[ic].num_children == 1 :
                            symbol_children = form_manager.idx2symbol.get(t.children[ic].children[0])
                            try :
                                if isinstance(int(symbol_children), int):
                                    w_list.append(10) # Numbers
                            except:
                                w_list.append(11) # unary functions [sin, cos, x]
                        elif t.children[ic].num_children == 2:
                            w_list.append(4)
                        elif t.num_children == 3:
                            symbol_children = form_manager.idx2symbol.get(t.children[ic].children[1])
                            if symbol_children == '+':
                                w_list.append(5)
                            elif symbol_children == '*':
                                w_list.append(6)
                            elif symbol_children == '/':
                                w_list.append(7)
                            elif symbol_children == '^':
                                w_list.append(8)
                            elif isinstance(int(symbol_children), int):
                                w_list.append(10)
                        elif t.num_children == 2:
                            w_list.append(9)
                        elif t.num_children == 4:
                            w_list.append(4)
                        else:
                            w_list.append(4)
                        # w_list.append(4)
