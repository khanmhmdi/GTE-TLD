...
def get_args():
    ...
    parser.add_argument(
        "--dataset_yaml",
        type=str,
        default="C:/Users/Khanmhmdi/Desktop/graph4nlp-master/examples/pytorch/math_word_problem/mawps_ibp/config/new_dynamic_graphsage_undirected.yaml",  # noqa
    )
    ...
    # dataset config
    parser.add_argument("--batch-size", type=int, default=2048, help="the size of one mini-batch")
    ...
    parser.add_argument(
        "--checkpoint-save-path", type=str, default="examples/pytorch/math_word_problem/mawps_ibp/save"
    )
