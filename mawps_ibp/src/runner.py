...
class Mawps:
    ...
    def _build_model(self):
        ...
        #     'C:/Users\Khanmhmdi\Desktop\graph4nlp-master\examples\pytorch\math_word_problem\mawps_ibp\src\examples\pytorch\math_word_problem\mawps_ibp\save\epoch_185.pt'))
    ...
    def train(self):
        ...
        for epoch in range(700, self.opt["max_epochs"] + 1):
            self.model.train()
